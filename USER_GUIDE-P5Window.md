...
## Main Areas
- **Server list** (sidebar): add/edit/delete server configs; import/export as JSON.
...
- **Volumes panel** (shown after Licence):
...
6. Use the `Export` menu in the toolbar to generate a CSV report:
